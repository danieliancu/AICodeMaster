...
const UI_DB_TEXTS: Record<AiLanguage, Record<string, string>> = {
  ro: {
    ...
    xrayModeOn: "Pornit",
    xrayModeOff: "Oprit",
    xrayDrawerTitle: "Inspector X-Ray CSS",
    xrayEmptyState: "Selecteaza un element din panoul Model pentru a inspecta CSS-ul complet.",
    xrayDesktopOnlyHint: "X-Ray este disponibil pe desktop.",
    xrayHelpHint: "Treci cu mouse-ul pentru detalii. Click pe element pentru CSS complet.",
  ...
  en: {
    ...
    xrayModeOn: "On",
    xrayModeOff: "Off",
    xrayDrawerTitle: "X-Ray CSS Inspector",
    xrayEmptyState: "Select an element in the Model panel to inspect full CSS.",
    xrayDesktopOnlyHint: "X-Ray is available on desktop.",
    xrayHelpHint: "Hover for details. Click an element to open full CSS.",
  ...
  es: {
    ...
    xrayModeLabel: "X-Ray",
    xrayModeOn: "Activo",
    xrayModeOff: "Inactivo",
    xrayDrawerTitle: "Inspector CSS X-Ray",
    xrayEmptyState: "Selecciona un elemento en el panel Modelo para inspeccionar el CSS completo.",
    xrayDesktopOnlyHint: "X-Ray esta disponible en desktop.",
    xrayHelpHint: "Pasa el cursor para detalles. Haz click para abrir CSS completo.",
  ...
  fr: {
    ...
    xrayModeOn: "Actif",
    xrayModeOff: "Inactif",
    xrayDrawerTitle: "Inspecteur CSS X-Ray",
    xrayEmptyState: "Selectionne un element dans le panneau Modele pour inspecter le CSS complet.",
    xrayDesktopOnlyHint: "X-Ray est disponible sur desktop.",
    xrayHelpHint: "Survole pour details. Clique sur un element pour ouvrir le CSS complet.",
  ...
  de: {
    ...
    xrayModeOn: "An",
    xrayModeOff: "Aus",
    xrayDrawerTitle: "X-Ray CSS Inspektor",
    xrayEmptyState: "Waehle ein Element im Modell-Panel, um das vollstaendige CSS zu sehen.",
    xrayDesktopOnlyHint: "X-Ray ist auf Desktop verfuegbar.",
    xrayHelpHint: "Hover fuer Details. Klicke fuer vollstaendiges CSS.",
  ...
  it: {
    ...
    xrayModeLabel: "X-Ray",
    xrayModeOn: "Attivo",
    xrayModeOff: "Disattivo",
    xrayDrawerTitle: "Ispettore CSS X-Ray",
    xrayEmptyState: "Seleziona un elemento nel pannello Modello per ispezionare il CSS completo.",
    xrayDesktopOnlyHint: "X-Ray e disponibile su desktop.",
    xrayHelpHint: "Passa il mouse per dettagli. Clicca per aprire il CSS completo.",
  ...
  pt: {
    ...
    xrayModeOn: "Ativo",
    xrayModeOff: "Inativo",
    xrayDrawerTitle: "Inspetor CSS X-Ray",
    xrayEmptyState: "Selecione um elemento no painel Modelo para inspecionar o CSS completo.",
    xrayDesktopOnlyHint: "X-Ray esta disponivel no desktop.",
    xrayHelpHint: "Passe o cursor para detalhes. Clique para abrir o CSS completo.",
